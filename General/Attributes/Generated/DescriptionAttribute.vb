''' <summary>This attribute should be used to decorate Classes or Properties so that they are correctly displayed.</summary>
''' <autogenerated>Generated from a T4 template. Modifications will be lost, if applicable use a partial class instead.</autogenerated>
''' <generator-date>10/02/2014 15:37:32</generator-date>
''' <generator-functions>1</generator-functions>
''' <generator-source>Leviathan\General\Attributes\Generated\DescriptionAttribute.tt</generator-source>
''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
''' <generator-version>1</generator-version>
<System.CodeDom.Compiler.GeneratedCode("Leviathan\General\Attributes\Generated\DescriptionAttribute.tt", "1")> _
<AttributeUsageAttribute(AttributeTargets.[Class] Or AttributeTargets.[Property], _
	AllowMultiple:=False, Inherited:=False)> _
Partial Public NotInheritable Class DescriptionAttribute
				...
				Public Shared Function GetMembers( _
					...
					Return Leviathan.Inspection.TypeAnalyser.GetInstance(onType) _
						.ExecuteQuery(Leviathan.Inspection.AnalyserQuery.QUERY_MEMBERS_READABLE _
							.SetPresentAttribute(GetType(DescriptionAttribute)) _
					)
