Namespace Commands
	...
	''' <generator-date>10/02/2014 15:43:33</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Leviathan\_Commands\Commands\Generated\StringCommands.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Leviathan\_Commands\Commands\Generated\StringCommands.tt", "1")> _
	<Leviathan.Commands.Command(ResourceContainingType:=GetType(StringCommands), ResourceName:="CommandDetails", Name:="strings", Description:="@commandStringsDescription@", Hidden:=False)> _
