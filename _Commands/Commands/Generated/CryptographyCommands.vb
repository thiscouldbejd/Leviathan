Namespace Commands
	...
	''' <generator-date>10/02/2014 15:42:28</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Leviathan\_Commands\Commands\Generated\CryptographyCommands.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Leviathan\_Commands\Commands\Generated\CryptographyCommands.tt", "1")> _
	<Leviathan.Commands.Command(ResourceContainingType:=GetType(CryptographyCommands), ResourceName:="CommandDetails", Name:="cryptography", Description:="@commandCryptographyDescription@", Hidden:=False)> _
