Namespace Commands
	...
	''' <generator-date>10/02/2014 15:42:11</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Leviathan\_Commands\Attributes\Generated\ParsingInParameterAttribute.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Leviathan\_Commands\Attributes\Generated\ParsingInParameterAttribute.tt", "1")> _
	<AttributeUsageAttribute(AttributeTargets.Parameter, _
		AllowMultiple:=False, Inherited:=True)> _
	Partial Public NotInheritable Class ParsingInParameterAttribute
					...
					Public Shared Function GetMembers( _
						...
						Return Leviathan.Inspection.TypeAnalyser.GetInstance(onType) _
							.ExecuteQuery(Leviathan.Inspection.AnalyserQuery.QUERY_MEMBERS_READABLE _
								.SetPresentAttribute(GetType(ParsingInParameterAttribute)) _
						)
