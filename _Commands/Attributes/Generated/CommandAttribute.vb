Namespace Commands
	...
	''' <summary>This attribute should be used to decorate a Command Class/Command Method. The name will be used to help identify/parse the command. The description should help the user understand the purpose of the Command Method.</summary>
	''' <autogenerated>Generated from a T4 template. Modifications will be lost, if applicable use a partial class instead.</autogenerated>
	''' <generator-date>10/02/2014 15:41:57</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Leviathan\_Commands\Attributes\Generated\CommandAttribute.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Leviathan\_Commands\Attributes\Generated\CommandAttribute.tt", "1")> _
	<AttributeUsageAttribute(AttributeTargets.[Class] Or AttributeTargets.[Method], _
		AllowMultiple:=True, Inherited:=False)> _
	Partial Public NotInheritable Class CommandAttribute
