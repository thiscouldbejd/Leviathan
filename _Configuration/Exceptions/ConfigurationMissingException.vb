Namespace Configuration
	...
	''' <generator-date>10/02/2014 15:49:56</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Leviathan\_Configuration\Exceptions\ConfigurationMissingException.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Leviathan\_Configuration\Exceptions\ConfigurationMissingException.tt", "1")> _
	<Leviathan.Description(Description:="Exception which should be thrown when a required Provider Object is not available")> _
	Partial Public Class ConfigurationMissingException
		Inherits Exception
		...
		#Region " Public Properties "
			...
			''' <remarks></remarks>
			<Leviathan.Description(Description:="Name of the XML Attribute which is Missing")> _
