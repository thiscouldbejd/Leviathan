Namespace Inspection
	...
	''' <summary>Query Part for No Attribute Presence.</summary>
	''' <autogenerated>Generated from a T4 template. Modifications will be lost, if applicable use a partial class instead.</autogenerated>
	''' <generator-date>10/02/2014 15:52:44</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Leviathan\_Inspection\Querying\Generated\NoAttributePart.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Leviathan\_Inspection\Querying\Generated\NoAttributePart.tt", "1")> _
		...
		#Region " Class Plumbing/Interface Code "
			...
			#Region " Hashable Implementation "
				...
				#Region " Public Methods "
					...
					Public Overrides Function GetHashCode() As System.Int32
						Return Leviathan.Caching.Simple.CombineHashCodes(GetType(NoAttributePart), AttributeType)
					End Function
			...
			#Region " Settable Implementation "
				...
				#Region " Public Methods "
					...
					Public Function SetAttributeType(_AttributeType As System.Type) As NoAttributePart
